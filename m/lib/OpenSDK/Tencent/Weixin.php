...
class OpenSDK_Tencent_Weixin extends OpenSDK_OAuth_Interface
{
    const ACCESS_TOKEN = 'weixin_access_token';
    const REFRESH_TOKEN = 'weixin_refresh_token';
    const EXPIRES_IN = 'weixin_expires_in';
    const SCOPE = 'weixin_scope';
    const OPENID = 'weixin_openid';
    const UNIONID = 'weixin_unionid';
    /**
     * app key
     * @var string
     */
    ...
    private static $authorizeURL = 'https://open.weixin.qq.com/connect/qrconnect';
    /**
     * OAuth 版本
     * @var string
     */
