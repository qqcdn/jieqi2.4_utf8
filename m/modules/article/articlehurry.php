...
$jieqiTset['jieqi_contents_template'] = $jieqiModules['article']['path'] . '/templates/articlehurry.html';
...
$sql = 'SELECT count(*) as count, sum(minwords) as minwords, sum(payegold) as payegold  FROM ' . jieqi_dbprefix('article_hurry') . ' WHERE ' . $slimit . ' LIMIT 0,1';
$query->execute($sql);
$row = $query->getRow();
