...
class QPayConfig
{
	 ...
	 * @var path
	 */
	const SSLCERT_PATH = '../../configs/pay/qpay/apiclient_cert.pem';
	const SSLKEY_PATH = '../../configs/pay/qpay/apiclient_key.pem';
	 ...
	 * 不会影响接口调用流程），开启上报之后，方便QQ监控请求调用的质量，建议至少
	 * 开启错误上报。
...
*/
$jieqiPayset[JIEQI_PAY_TYPE]['payreturn'] = JIEQI_LOCAL_URL.'/modules/pay/qnativereturn.php';  //本站接收前台返回的网址
$jieqiPayset[JIEQI_PAY_TYPE]['paynotify'] = JIEQI_LOCAL_URL.'/modules/pay/qnativenotify.php';  //本站接收后台通知的网址
...
//充值类型
$jieqiPayset[JIEQI_PAY_TYPE]['paytype'] = 'QQ扫码'; //支付类型
