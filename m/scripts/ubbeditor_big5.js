...
var UBBEditor = {
	...
	InsertImage : function(){
		...
		menuInsertImage.onclick = function(){
			var imgurl = prompt("叫块瓜隔畖", "http://");
	...
	SmileList : function(){
		...
		var smList = [];
		smList.push(['/:O', '1.gif', '佩砓']);
		smList.push(['/:~', '2.gif', '篔糒']);
		smList.push(['/:*', '3.gif', '︹︹']);
		smList.push(['/:|', '4.gif', '只']);
		smList.push(['/8-)', '5.gif', '眔种']);
		smList.push(['/:LL', '6.gif', '瑈瞈']);
		smList.push(['/:$', '7.gif', '甡槽']);
		smList.push(['/:X', '8.gif', '超糒']);
		smList.push(['/:Z', '9.gif', '何谋']);
		smList.push(['/:`(', '10.gif', '']);
		smList.push(['/:-', '11.gif', '廓Ъ']);
		smList.push(['/:@', '12.gif', '只']);
		smList.push(['/:P', '13.gif', '秸ブ']);
		smList.push(['/:D', '14.gif', '蜯']);
		smList.push(['/:)', '15.gif', '稬']);
		smList.push(['/:(', '16.gif', '螟筁']);
		smList.push(['/:+', '17.gif', '瑼慌']);
		smList.push(['/:#', '18.gif', '窽ē']);
		smList.push(['/:Q', '19.gif', 'ъ╣']);
		smList.push(['/:T', '20.gif', '姑']);
