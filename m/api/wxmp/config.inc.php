<?php
//微信登录接口参数设置
//未申请微信登录接口账号的，请到 https://mp.weixin.qq.com/ 提交申请

$apiOrder = 12; //接口序号，请勿修改
$apiName = 'wxmp'; //接口名，请勿修改
$apiTitle = '微信公众号'; //接口标题，请勿修改
...
$apiConfigs[$apiName]['scope'] = 'snsapi_base,snsapi_userinfo'; //允许授权哪些api接口，用英文逗号分隔 'snsapi_base,snsapi_userinfo'(如果用snsapi_userinfo 会提示用户授权，snsapi_base 不提示授权，只能获取openid)
