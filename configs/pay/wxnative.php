...
*/
$jieqiPayset[JIEQI_PAY_TYPE]['payreturn'] = JIEQI_LOCAL_URL.'/modules/pay/wxnativereturn.php';  //本站接收前台返回的网址
$jieqiPayset[JIEQI_PAY_TYPE]['paynotify'] = JIEQI_LOCAL_URL.'/modules/pay/wxnativenotify.php';  //本站接收后台通知的网址
...
//充值类型
$jieqiPayset[JIEQI_PAY_TYPE]['paytype'] = '微信扫码'; //支付类型
