...
*/
$jieqiPayset[JIEQI_PAY_TYPE]['payreturn'] = JIEQI_LOCAL_URL.'/modules/pay/qjsapireturn.php';  //本站接收前台返回的网址
$jieqiPayset[JIEQI_PAY_TYPE]['paynotify'] = JIEQI_LOCAL_URL.'/modules/pay/qjsapinotify.php';  //本站接收后台通知的网址
...
//充值类型
$jieqiPayset[JIEQI_PAY_TYPE]['paytype'] = 'QQ钱包'; //支付类型
